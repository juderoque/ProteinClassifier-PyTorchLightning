...
class PfamPartition(Dataset):
    def __init__(self, data, fams, vocab, padding, fam_vocab):
...
class PfamDataset:
    def __init__(self, data_dir='data/random_split', sample_every=1, padding=3000):
        vocab = {"<PAD>": 0, ".": 1, "M": 2, "H": 3, "B": 4, "W": 5, "R": 6, "U": 7, "I": 8, "O": 9, "L": 10,
                      "T": 11, "D": 12, "F": 13, "X": 14, "Q": 15, "K": 16, "N": 17, "A": 18, "E": 19, "Y": 20, "V": 21,
                      "Z": 22, "S": 23, "P": 24, "C": 25, "G": 26}
        ...
        self.train_set = PfamPartition(train, fams, vocab, padding, fam_vocab)
        self.val_set = PfamPartition(val, fams, vocab, padding, fam_vocab)
        self.test_set = PfamPartition(test, fams, vocab, padding, fam_vocab)
